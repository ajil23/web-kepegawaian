...
@section('page-title', 'Tambah Data Diri')
...
<div class="bg-white rounded-xl shadow-sm border border-slate-100 mb-6">
    ...
    <div class="p-6 border-b border-slate-100 flex justify-between items-center">
        <h3 class="font-bold text-slate-800">Tambah Data Diri</h3>
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('pegawai.data_diri.store') }}" class="p-6 space-y-6" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="alamat" rows="3" required
                    class="w-full px-4 py-2.5 rounded-lg border border-slate-200 text-sm
                    focus:ring-2 focus:ring-green-500 focus:border-green-500">{{ old('alamat') }}</textarea>
            ...
            <div class="md:col-span-2">
                ...
                <div class="mt-4">
                    <img id="fotoPreview" src="#" alt="Preview Foto"
                        class="hidden w-32 h-32 object-cover rounded-full border border-slate-200">
                </div>
            </div>
